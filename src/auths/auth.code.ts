...
export enum AuthCode {
    ...
    AUTH_LOGOUT_SUCCESS = 'User has been successfully logged out',
    ...
    AUTH_TOKEN_BLACKLISTED = 'Token has been blacklisted',
    AUTH_TOKEN_MISSING = 'Token is missing from authorization header',
    AUTH_TOKEN_INVALID = 'Invalid or expired token',
    AUTH_USER_SESSION_INVALID = 'User session is invalid',
